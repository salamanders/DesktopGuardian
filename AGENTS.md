...
All agents (human or AI) working on this project must follow these instructions and check off items as they are
completed.
...
3. **Pure JVM:** The project targets the JVM (Windows & macOS). Use `System.getProperty("os.name")` for platform
   detection and standard Java APIs or JNA where necessary. Avoid Kotlin/Native unless strictly required.
...
3. [x] **3.3. Implement Diffing Engine**
    ...
    4. [x] *Verification:* Write unit tests with mock data (Old State vs New State) to verify correct alerts are
       generated.
...
2. [ ] **6.2. Firefox LZ4 Decompression**
    1. [x] **CANCELLED** per user instruction.

---

## Phase 7: Alerting System (Google Sheets Webhook)

1. [x] **7.1. Implement WebHook Service**
